# Mirror 使用手册中文版
## 入门
入门版是一种通过限量版 NFT 使 Mirror 上的文字成为收藏品的方式。您需要做的就是在您的条目中添加封面图片并创建您的帖子。
### 等级
入门版按等级定价，让您最大的支持者能够获得有价值和独特的东西，同时让您的所有读者以可承受的价格点收集东西。定价和供应是这样的：
...
### 铸造你的条目
在仪表板内的条目设置中使您的帖子具有收藏价值。

- 封面图片
	- 首先，为您的帖子选择封面图片。将您的条目视为一本精美杂志的精选社论。可视化它的最佳方法是什么？包括一个漂亮的背景图片和一个大标题！
	- 然后，导航到编辑器右上角的条目设置。

		![](./pic/mirror14.png)
	
		在设置中，上传您的封面图片。封面图片应为 2880 x 1440 像素，以便在各种设备上看起来都很棒。

		如果您的封面图片包含帖子的标题，请勾选“在条目中隐藏标题”以避免出现多余的标题。
...
- 铸造 NFT
	...
	点击“保存”或“发布”以创建条目。您会看到一个带有封面图片的确认模式弹出。
- 资金接受者

	指定您希望从 NFT 销售中接收资金的位置。这可能是您自己的钱包地址，但也可以是以太坊上能够接收 ETH 的任何地址，包括镜像拆分！
	
	如果一切看起来都不错，请按“发布和造币厂条目”。
	
	系统会提示您确认钱包中的交易。交易确认后，您的参赛作品将成为收藏品！

	导航到条目永久链接以查看它并与您的读者分享。

## NFT
### NFT 入口
Mirror 上的条目可以铸造为 NFT。要将您的条目创建为 NFT，请选中条目编辑器右上角的 NFT 复选框。为您的条目上传封面图片，以便它可以在不同的 NFT 平台上呈现。一旦您的 NFT 在链上铸造，您将在条目的署名行中看到确认。

您可以通过编辑、选中 NFT 复选框并保存条目来追溯创建以前的条目。在仪表板的“条目”选项卡下查看您的哪些条目已被铸造为 NFT。
...
## 众筹
在 Mirror 任何人都可以使用 Crowdfund(众筹) 块为想法或项目筹集资金。在幕后，众筹是以太坊上的智能合约。支持者存入 ETH 来资助您的想法以换取代币。代币代表赞助证明和项目潜在成功的股份。众筹可以嵌入到 Mirror 上的任何条目中，以及讲述您项目故事的文本和其他媒体块。

Mirror 上的条目可以铸造为 NFT。要将您的条目创建为 NFT，请选中条目编辑器右上角的 NFT 复选框。为您的条目上传封面图片，以便它可以在不同的 NFT 平台上呈现。一旦您的 NFT 在链上铸造，您将在条目的署名行中看到确认。它最初发布的地方是 [出版物](https://mint.mirror.xyz/mDws2xGmJCq55ehGDdcv8tGDCpSd_c_CfeqhexiKSqU)。

![](./pic/mirror13.png)

- 例子

	在 Mirror 上查看这些众筹，以获取有关如何展示您的众筹的灵感。
...
- 开始
	...
	任何人都可以通过转到 Mirror Dashboard 中的 Crowdfunds 选项卡并配置一些基本设置来创建 Crowdfund。

	众筹可以是最小的只有一个名称和一个资金目标或者包括一个具有 NFT 奖励等级的更制作的活动。
	...
	- 基本
		...
		- `封面图片`
			...
			封面图片就像专辑封面或电影海报。它应该以艺术的方式直观地概括您的项目。它出现在您的条目顶部，并用作跨社交媒体平台的预览卡。图像必须是 2:1。建议的分辨率为 3000x1500 像素。
	- 目标和资金
...
- 添加功能
	...
	- 令牌
		...
		所有众筹都需要令牌。您项目的支持者会自动收到一个代币以换取他们的 ETH。令牌跟踪每个支持者为您的项目做出了多少贡献。代币以 1000 代币比 1 ETH 的比例发行。

		您的代币主要充当“赞助证明”，为您的支持者提供一个纪念他们支持的收藏品。代币还可用于代表您项目社区中的成员资格（例如，代币门控的 Discord）。通过将未来收入返回给代币，代币还可以代表您项目未来成功的经济利益。
	...
	- NFT 层级
		...
		类似于 Kickstater 活动中为支持者提供某些好处和特权的奖励等级，Mirror 众筹支持 NFT 奖励等级。
	
		您可以创建多个分层的 NFT 版本来奖励您的支持者。
	
		NFT 层需要以下字段：
	
		- 媒体：代表 NFT 艺术作品的图像或视频
		- 描述：层级的描述，包括支持者购买 NFT 的潜在福利
		- 价格：奖励的价格
		- 总供应量：可用版本总数
		...
		- 为您最大的粉丝提供昂贵但稀缺的层级
		- 中等支持者的稍微便宜且更丰富的等级
		- 价格实惠的等级，适合那些希望将自己的名字与您的项目相关联并获得一些很酷的奖励的人
		
		还要考虑与您的总体资金目标相关的层级定价。您可能应该通过仅售出 50-70% 的等级来达到您的融资目标。这也将为您提供一些空间来实现延伸目标。
	- 赞助人讲台
	
		领奖台让您项目的最大支持者竞争排行榜的前三名。与定时拍卖类似，当讲台计时器用完时，前三名支持者将获得独特的 NFT。登上领奖台是发现最大粉丝的好方法，让项目能够在固定价格层级之外筹集到更多的资金。
	
		赞助人讲台需要以下字段：
	
		- 媒体：上传代表每个讲台位置的 NFT 的媒体
		- 持续时间：类似于定时拍卖，在做出初始贡献后讲台保持开放的时间领奖台计时器的工作原理类似于储备拍卖：
		- 在对众筹做出初始贡献后，倒计时	开始
		- 如果时钟还剩 15 分钟或更少，并且有新的领奖台贡献，则时钟将重置为 15 分钟
	
		重置时钟可在领奖台倒计时的最后几分钟进行竞标。
	
		虽然领奖台资格在领奖台计时器用完时结束，但众筹将保持开放，直到您通过仪表板手动关闭资金。您可以在整个活动结束时与您的支持者沟通并手动关闭它。
- 发布
	...
	- 故事
		...
		Crowdfund Story Creator 是您创建面向公众的页面的地方，该页面将被共享以宣传您的众筹。它是一个内联编辑器——类似于 Google Docs 或 Notion。

		您可以通过使用Story Blocks添加内容来讲述众筹背后的故事。第一个区块是为您的众筹概览保留的，可以通过点击“描述您的故事”进行编辑。它看起来像这样：
...
## 拍卖
Mirror 支持使用储备拍卖来拍卖 NFT。保留拍卖配置有两个主要参数：

- 保留价格
- 拍卖持续时间

与 Mirror 上的其他经济区块一样，您的拍卖是作为智能合约部署的，可以嵌入到任何 Mirror 条目中。

![](./pic/mirror26.png)

### 拍卖如何运作
当出价匹配或超过您的底价时，拍卖持续时间倒计时开始。让我们想象一下，Alice 以 1 ETH 的底价和 12 小时的持续时间创建了一个拍卖。
...
- 资金路线
	...
	拍卖的收益可以路由到任何以太坊地址或智能合约。如果您想为自己分配资金，请在此处输入您的以太坊地址。

	- 或资金可以流向 Mirror 上的其他经济区块，例如众筹或拆分。要将 NFT 拍卖的收益转移到您的众筹，请在此处输入您的众筹地址。您还可以通过将资金路由到拆分合约地址来与多个实体共享资金。
- 设置限制

	第一次出价后拍卖应该进行多长时间？底价应该是多少？

### 嵌入拍卖
部署后该 `Embed auction` 部分将显示一段代码。将其复制并粘贴到条目中。它应该类似于下面的示例，但带有您的专用拍卖地址和 `tokenID`. 例如，此代码在本指南的顶部嵌入了拍卖。

	[Token #1522](auction://0xabEFBc9fD2F806065b4f3C237d4b59D9A97Bcac7?network=mainnet&tokenId=1522)

## 拆分
镜像拆分是一种自动与多个实体共享您产生的价值的方法。拆分是一种可支付的智能合约，可将价值路由到以太坊上的多个地址。

拆分可以用作奖励您的合作者、激励您的人或捐赠您的工作收益的一种方式。

通过转到仪表板中的“拆分”选项卡来创建拆分。至少需要在两个地址之间进行拆分，并且百分比之和必须为 100%。

	警告：拆分目前仅适用于 ETH。将 ERC-20 代币发送到分裂将导致它们被永久锁定。
### 在拍卖中使用拆分
拆分可以很容易地与 Mirror 上的其他价值产生块组合在一起，例如拍卖。您可以将拍卖的所有收益分配给多个实体，而不是自己保留拍卖的所有收益。

首先在仪表板的拆分部分创建拆分。部署拆分后复制拆分的地址。现在，创建一个新的拍卖并将拆分地址粘贴到 `Funds Recipient` 字段中。

拍卖结束后，资金将在拆分合约中指定的接收者之间自动共享。

拆分也可以在 Mirror 之外接收 ETH，就像任何应付的智能合约或 EOA。
## Editions(1155?)
Editions 是创作者以固定价格铸造有限供应的相同 NFT 的一种方式。如果 1/1 NFT 是苏富比的毕加索，那么 Editions 就像发布的数以千计的第一版全息喷火龙。

Mirror 上的 Editions 配置有四个参数：
...
与 Mirror 上的其他经济区块一样，您的版本作为智能合约部署，可以嵌入任何 Mirror 条目中。
...
- 添加标题和描述
	...
	当嵌入条目中时，标题和描述将显示在版本块中。
- 设定价格和供应

	可以根据 Editions 目标设置自定义 ETH 价格和供应上限。例如，可以设置高价和低供应来表示稀有。另一方面，你可以设置低价高供应，让更多人参与和接收 NFT。
...
### 嵌入Editions 
Editions 部署 `Embed`  后，仪表板的版本页面部分将显示一段代码。将其复制并粘贴到条目中。它应该类似于下面的示例，但带有您的专用版本地址和 editionId.
...
- 创建代币竞赛
	...
	您可以通过转到从仪表板创建令牌竞赛 `/dashboard/token-race`。
	...
	创建令牌竞赛后，您可以单击仪表板中的令牌竞赛以转到令牌竞赛页面。
- 代币快照
...
- 删除代币竞赛
	...
	您可以在代币竞赛上线之前从仪表板中删除它。您只能在它们上线之前删除代币竞赛。您无法删除已结束的代币竞赛。删除令牌竞赛会将其从镜像 UI 中删除，但数据将继续存在于 IPFS 上。	
...
- 为提议者链接推特
	...
	创建代币竞赛后，您可以要求您的提议者去镜像主页链接他们的推特账户。一旦他们链接了他们的帐户，他们的推特详细信息将与他们的提案一起显示在您的代币竞赛页面上。
- 投票的工作原理
...
- 一旦你分配了选票并投票，Metamask 会提示你从你的硬件钱包中签署消息
	...
	![](./pic/mirror24.png)	
- 在元掩码上点击“签名”后，您会在硬件钱包上看到一个弹出窗口，要求您签署交易
- 通过点击右侧按钮完成这些步骤，然后确认“签署消息”
- 返回令牌竞赛页面，您将看到带有“投票”消息的模态文本更新

	![](./pic/mirror25.png)
- 几秒钟后，模态将关闭，页面将更新以反映您所投的票。您还会注意到分配选票后您的投票权有所下降		

## 编辑
镜像编辑器允许使用媒体块（例如图像和视频）以及加密经济块（例如众筹和拍卖）来撰写条目。它使用纯文本和 Markdown 以及一些格式约定。

### 模式
合成发生在 `Edit` 模式中。要预览您的条目，请进入 `Preview` 模式,因为它将出现在您的出版物中。您可以使用工具栏中的相关按钮在它们之间切换。
### 导入条目
要从其他地方导入条目，例如 Medium 或 Substack，请打开 `•••` 导航中的二级菜单，然后单击 `Import entry`。接下来，输入您的条目的 URL。url 将被解析为 markdown，并设置为您的条目的内容。请仅导入您创建和拥有的内容。
### 创建块
要轻松创建媒体或经济区块，请先在条目内单击以将光标放置在您希望区块出现的位置。接下来，单击工具栏的块区域或使用键盘快捷键聚焦 `⌘+/`。将出现块菜单，显示所有可用的块。选择一个块会提示您输入辅助信息。满意后，请确认信息以将块插入到您的条目中。
...
Mirror 上的条目可以铸造为 NFT。要将您的条目创建为 NFT，请选中条目编辑器右上角的 NFT 复选框。为您的条目上传封面图片，以便它可以在不同的 NFT 平台上呈现。一旦您的 NFT 在链上铸造，您将在条目的署名行中看到确认。
### 众筹
在 Mirror 上，任何人都可以使用 Crowdfund 块为想法或项目筹集资金。在幕后，众筹是以太坊上的智能合约。支持者存入 ETH 来资助您的想法以换取代币。代币代表赞助证明和项目潜在成功的股份。众筹可以嵌入到 Mirror 上的任何条目中，以及讲述您项目故事的文本和其他媒体块。
### 拍卖
[创建拍卖](https://mirror.xyz/dashboard/auctions)并部署它。部署后，该 Embed auction 部分将显示一段代码。将其复制并粘贴到条目中。它应该类似于下面的示例，但带有您的专用拍卖地址和tokenID.
...
![](./pic/mirror11.png)		
### 版面尺寸
如果您希望为您的条目创建更具编辑性的布局，请考虑为某些媒体块设置自定义布局大小。支持的块类型包括图像、视频、Youtube 和 iFrame。
